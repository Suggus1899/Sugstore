...
export function ProductCardDefault({ product, index = 0 }: Props) {
  ...
  return (
    <article
      className={`animate-rise ${delayClass} card-shine group flex flex-col overflow-hidden rounded-2xl border border-border bg-surface transition-all hover:shadow-xl hover:shadow-black/30`}
    >
      <Link
